...
module RoCE_udp_tx_mod  #(
    ...
    reg        busy_reg                            = 1'b0;
    reg        error_payload_early_termination_reg = 1'b0,
               error_payload_early_termination_next;

    // -----------------------------------------------------------------------
    // Save register for payload shifting
    // -----------------------------------------------------------------------
    ...
    reg [DATA_WIDTH-1:0] shift_roce_payload_96_axis_tdata_reg;
    reg [KEEP_WIDTH-1:0] shift_roce_payload_96_axis_tkeep_reg;
    reg                  shift_roce_payload_96_axis_tvalid_reg;
    reg                  shift_roce_payload_96_axis_tlast_reg;
    reg                  shift_roce_payload_96_axis_tuser_reg;
    reg                  shift_roce_payload_96_axis_input_tready_reg;

    reg [DATA_WIDTH-1:0] shift_roce_payload_128_axis_tdata_reg;
    reg [KEEP_WIDTH-1:0] shift_roce_payload_128_axis_tkeep_reg;
    reg                  shift_roce_payload_128_axis_tvalid_reg;
    reg                  shift_roce_payload_128_axis_tlast_reg;
    reg                  shift_roce_payload_128_axis_tuser_reg;
    reg                  shift_roce_payload_128_axis_input_tready_reg;

    reg [DATA_WIDTH-1:0] shift_roce_payload_224_axis_tdata_reg;
    reg [KEEP_WIDTH-1:0] shift_roce_payload_224_axis_tkeep_reg;
    reg                  shift_roce_payload_224_axis_tvalid_reg;
    reg                  shift_roce_payload_224_axis_tlast_reg;
    reg                  shift_roce_payload_224_axis_tuser_reg;
    reg                  shift_roce_payload_224_axis_input_tready_reg;

    reg [DATA_WIDTH-1:0] shift_roce_payload_256_axis_tdata_reg;
    reg [KEEP_WIDTH-1:0] shift_roce_payload_256_axis_tkeep_reg;
    reg                  shift_roce_payload_256_axis_tvalid_reg;
    reg                  shift_roce_payload_256_axis_tlast_reg;
    reg                  shift_roce_payload_256_axis_tuser_reg;
    reg                  shift_roce_payload_256_axis_input_tready_reg;
    ...
    wire [DATA_WIDTH-1:0] shift_roce_payload_96_axis_tdata  = shift_roce_payload_96_axis_tdata_reg;
    wire [KEEP_WIDTH-1:0] shift_roce_payload_96_axis_tkeep  = shift_roce_payload_96_axis_tkeep_reg;
    wire                  shift_roce_payload_96_axis_tvalid = shift_roce_payload_96_axis_tvalid_reg;
    wire                  shift_roce_payload_96_axis_tlast  = shift_roce_payload_96_axis_tlast_reg;
    wire                  shift_roce_payload_96_axis_tuser  = shift_roce_payload_96_axis_tuser_reg;
    wire                  shift_roce_payload_96_axis_input_tready = shift_roce_payload_96_axis_input_tready_reg;

    wire [DATA_WIDTH-1:0] shift_roce_payload_128_axis_tdata  = shift_roce_payload_128_axis_tdata_reg;
    wire [KEEP_WIDTH-1:0] shift_roce_payload_128_axis_tkeep  = shift_roce_payload_128_axis_tkeep_reg;
    wire                  shift_roce_payload_128_axis_tvalid = shift_roce_payload_128_axis_tvalid_reg;
    wire                  shift_roce_payload_128_axis_tlast  = shift_roce_payload_128_axis_tlast_reg;
    wire                  shift_roce_payload_128_axis_tuser  = shift_roce_payload_128_axis_tuser_reg;
    wire                  shift_roce_payload_128_axis_input_tready = shift_roce_payload_128_axis_input_tready_reg;

    wire [DATA_WIDTH-1:0] shift_roce_payload_224_axis_tdata  = shift_roce_payload_224_axis_tdata_reg;
    wire [KEEP_WIDTH-1:0] shift_roce_payload_224_axis_tkeep  = shift_roce_payload_224_axis_tkeep_reg;
    wire                  shift_roce_payload_224_axis_tvalid = shift_roce_payload_224_axis_tvalid_reg;
    wire                  shift_roce_payload_224_axis_tlast  = shift_roce_payload_224_axis_tlast_reg;
    wire                  shift_roce_payload_224_axis_tuser  = shift_roce_payload_224_axis_tuser_reg;
    wire                  shift_roce_payload_224_axis_input_tready = shift_roce_payload_224_axis_input_tready_reg;

    wire [DATA_WIDTH-1:0] shift_roce_payload_256_axis_tdata  = shift_roce_payload_256_axis_tdata_reg;
    wire [KEEP_WIDTH-1:0] shift_roce_payload_256_axis_tkeep  = shift_roce_payload_256_axis_tkeep_reg;
    wire                  shift_roce_payload_256_axis_tvalid = shift_roce_payload_256_axis_tvalid_reg;
    wire                  shift_roce_payload_256_axis_tlast  = shift_roce_payload_256_axis_tlast_reg;
    wire                  shift_roce_payload_256_axis_tuser  = shift_roce_payload_256_axis_tuser_reg;
    wire                  shift_roce_payload_256_axis_input_tready = shift_roce_payload_256_axis_input_tready_reg;

    // -----------------------------------------------------------------------
    // Internal datapath wires (to output skid buffer)
    // -----------------------------------------------------------------------
    ...
    always @(posedge clk) begin
        if (rst) begin
            shift_roce_payload_96_axis_tvalid_reg        <= 1'b0;
            shift_roce_payload_128_axis_tvalid_reg       <= 1'b0;
            shift_roce_payload_224_axis_tvalid_reg       <= 1'b0;
            shift_roce_payload_256_axis_tvalid_reg       <= 1'b0;
            shift_roce_payload_96_axis_input_tready_reg  <= 1'b0;
            shift_roce_payload_128_axis_input_tready_reg <= 1'b0;
            shift_roce_payload_224_axis_input_tready_reg <= 1'b0;
            shift_roce_payload_256_axis_input_tready_reg <= 1'b0;
        end else begin
            // -----------------------------------------------------------------
            // BTH only — 96-bit offset
            // -----------------------------------------------------------------
            if (OFFSET_BTH_ONLY == 0) begin
                shift_roce_payload_96_axis_tdata_reg        <= s_roce_payload_axis_tdata;
                shift_roce_payload_96_axis_tkeep_reg        <= s_roce_payload_axis_tkeep;
                shift_roce_payload_96_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_96_axis_tlast_reg        <= s_roce_payload_axis_tlast;
                shift_roce_payload_96_axis_tuser_reg        <= s_roce_payload_axis_tuser;
                shift_roce_payload_96_axis_input_tready_reg <= 1'b1;
            end else if (shift_roce_payload_96_extra_cycle_reg) begin
                shift_roce_payload_96_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_ONLY)*8);
                shift_roce_payload_96_axis_tkeep_reg        <= {{KEEP_WIDTH{1'b0}},        save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_ONLY);
                shift_roce_payload_96_axis_tvalid_reg       <= 1'b1;
                shift_roce_payload_96_axis_tlast_reg        <= save_roce_payload_axis_tlast_reg;
                shift_roce_payload_96_axis_tuser_reg        <= save_roce_payload_axis_tuser_reg;
                shift_roce_payload_96_axis_input_tready_reg <= flush_save;
            end else begin
                shift_roce_payload_96_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_ONLY)*8);
                shift_roce_payload_96_axis_tkeep_reg        <= {s_roce_payload_axis_tkeep, save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_ONLY);
                shift_roce_payload_96_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_96_axis_tlast_reg        <= s_roce_payload_axis_tlast &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_ONLY))) == 0);
                shift_roce_payload_96_axis_tuser_reg        <= s_roce_payload_axis_tuser &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_ONLY))) == 0);
                shift_roce_payload_96_axis_input_tready_reg <=
                    !(s_roce_payload_axis_tlast && s_roce_payload_axis_tready && s_roce_payload_axis_tvalid);
            end

            // -----------------------------------------------------------------
            // BTH + RETH — 224-bit offset
            // -----------------------------------------------------------------
            if (OFFSET_BTH_RETH == 0) begin
                shift_roce_payload_224_axis_tdata_reg        <= s_roce_payload_axis_tdata;
                shift_roce_payload_224_axis_tkeep_reg        <= s_roce_payload_axis_tkeep;
                shift_roce_payload_224_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_224_axis_tlast_reg        <= s_roce_payload_axis_tlast;
                shift_roce_payload_224_axis_tuser_reg        <= s_roce_payload_axis_tuser;
                shift_roce_payload_224_axis_input_tready_reg <= 1'b1;
            end else if (shift_roce_payload_224_extra_cycle_reg) begin
                shift_roce_payload_224_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_RETH)*8);
                shift_roce_payload_224_axis_tkeep_reg        <= {{KEEP_WIDTH{1'b0}},        save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_RETH);
                shift_roce_payload_224_axis_tvalid_reg       <= 1'b1;
                shift_roce_payload_224_axis_tlast_reg        <= save_roce_payload_axis_tlast_reg;
                shift_roce_payload_224_axis_tuser_reg        <= save_roce_payload_axis_tuser_reg;
                shift_roce_payload_224_axis_input_tready_reg <= flush_save;
            end else begin
                shift_roce_payload_224_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_RETH)*8);
                shift_roce_payload_224_axis_tkeep_reg        <= {s_roce_payload_axis_tkeep, save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_RETH);
                shift_roce_payload_224_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_224_axis_tlast_reg        <= s_roce_payload_axis_tlast &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_RETH))) == 0);
                shift_roce_payload_224_axis_tuser_reg        <= s_roce_payload_axis_tuser &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_RETH))) == 0);
                shift_roce_payload_224_axis_input_tready_reg <=
                    !(s_roce_payload_axis_tlast && s_roce_payload_axis_tready && s_roce_payload_axis_tvalid);
            end

            // -----------------------------------------------------------------
            // BTH + RETH + IMMDH — 256-bit offset
            // -----------------------------------------------------------------
            if (OFFSET_BTH_RETH_IMMDH == 0) begin
                shift_roce_payload_256_axis_tdata_reg        <= s_roce_payload_axis_tdata;
                shift_roce_payload_256_axis_tkeep_reg        <= s_roce_payload_axis_tkeep;
                shift_roce_payload_256_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_256_axis_tlast_reg        <= s_roce_payload_axis_tlast;
                shift_roce_payload_256_axis_tuser_reg        <= s_roce_payload_axis_tuser;
                shift_roce_payload_256_axis_input_tready_reg <= 1'b1;
            end else if (shift_roce_payload_256_extra_cycle_reg) begin
                shift_roce_payload_256_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH)*8);
                shift_roce_payload_256_axis_tkeep_reg        <= {{KEEP_WIDTH{1'b0}},        save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH);
                shift_roce_payload_256_axis_tvalid_reg       <= 1'b1;
                shift_roce_payload_256_axis_tlast_reg        <= save_roce_payload_axis_tlast_reg;
                shift_roce_payload_256_axis_tuser_reg        <= save_roce_payload_axis_tuser_reg;
                shift_roce_payload_256_axis_input_tready_reg <= flush_save;
            end else begin
                shift_roce_payload_256_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH)*8);
                shift_roce_payload_256_axis_tkeep_reg        <= {s_roce_payload_axis_tkeep, save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH);
                shift_roce_payload_256_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_256_axis_tlast_reg        <= s_roce_payload_axis_tlast &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH))) == 0);
                shift_roce_payload_256_axis_tuser_reg        <= s_roce_payload_axis_tuser &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_RETH_IMMDH))) == 0);
                shift_roce_payload_256_axis_input_tready_reg <=
                    !(s_roce_payload_axis_tlast && s_roce_payload_axis_tready && s_roce_payload_axis_tvalid);
            end

            // -----------------------------------------------------------------
            // BTH + IMMDH — 128-bit offset
            // -----------------------------------------------------------------
            if (OFFSET_BTH_IMMDH == 0) begin
                shift_roce_payload_128_axis_tdata_reg        <= s_roce_payload_axis_tdata;
                shift_roce_payload_128_axis_tkeep_reg        <= s_roce_payload_axis_tkeep;
                shift_roce_payload_128_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_128_axis_tlast_reg        <= s_roce_payload_axis_tlast;
                shift_roce_payload_128_axis_tuser_reg        <= s_roce_payload_axis_tuser;
                shift_roce_payload_128_axis_input_tready_reg <= 1'b1;
            end else if (shift_roce_payload_128_extra_cycle_reg) begin
                shift_roce_payload_128_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_IMMDH)*8);
                shift_roce_payload_128_axis_tkeep_reg        <= {{KEEP_WIDTH{1'b0}},        save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_IMMDH);
                shift_roce_payload_128_axis_tvalid_reg       <= 1'b1;
                shift_roce_payload_128_axis_tlast_reg        <= save_roce_payload_axis_tlast_reg;
                shift_roce_payload_128_axis_tuser_reg        <= save_roce_payload_axis_tuser_reg;
                shift_roce_payload_128_axis_input_tready_reg <= flush_save;
            end else begin
                shift_roce_payload_128_axis_tdata_reg        <= {s_roce_payload_axis_tdata, save_roce_payload_axis_tdata_reg} >> ((KEEP_WIDTH - OFFSET_BTH_IMMDH)*8);
                shift_roce_payload_128_axis_tkeep_reg        <= {s_roce_payload_axis_tkeep, save_roce_payload_axis_tkeep_reg} >> (KEEP_WIDTH - OFFSET_BTH_IMMDH);
                shift_roce_payload_128_axis_tvalid_reg       <= s_roce_payload_axis_tvalid;
                shift_roce_payload_128_axis_tlast_reg        <= s_roce_payload_axis_tlast &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_IMMDH))) == 0);
                shift_roce_payload_128_axis_tuser_reg        <= s_roce_payload_axis_tuser &&
                    ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH - OFFSET_BTH_IMMDH))) == 0);
                shift_roce_payload_128_axis_input_tready_reg <=
                    !(s_roce_payload_axis_tlast && s_roce_payload_axis_tready && s_roce_payload_axis_tvalid);
            end
        end
    end
    ...
    always @* begin
        ...
        // --- payload forwarding (registered shift results) ---
        if (send_roce_payload_reg == 3'd1) begin
            s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg && shift_roce_payload_96_axis_input_tready;
            ...
            if ((s_roce_payload_axis_tready && s_roce_payload_axis_tvalid) ||
                (m_udp_payload_axis_tready_int_reg && shift_roce_payload_96_extra_cycle_reg)) begin
            ...
            s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg && shift_roce_payload_224_axis_input_tready;
            ...
            if ((s_roce_payload_axis_tready && s_roce_payload_axis_tvalid) ||
                (m_udp_payload_axis_tready_int_reg && shift_roce_payload_224_extra_cycle_reg)) begin
                transfer_in_save              = 1'b1;
                m_udp_payload_axis_tvalid_int = 1'b1;
            ...
            s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg && shift_roce_payload_256_axis_input_tready;
            ...
            if ((s_roce_payload_axis_tready && s_roce_payload_axis_tvalid) ||
                (m_udp_payload_axis_tready_int_reg && shift_roce_payload_256_extra_cycle_reg)) begin
                transfer_in_save              = 1'b1;
                m_udp_payload_axis_tvalid_int = 1'b1;
            ...
            s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg && shift_roce_payload_128_axis_input_tready;
            ...
            if ((s_roce_payload_axis_tready && s_roce_payload_axis_tvalid) ||
                (m_udp_payload_axis_tready_int_reg && shift_roce_payload_128_extra_cycle_reg)) begin
                transfer_in_save              = 1'b1;
                m_udp_payload_axis_tvalid_int = 1'b1;
        ...
        if (m_udp_payload_axis_tready_int_reg &&
            (!OFFSET_BTH_ONLY || (send_roce_payload_reg == 3'd0) || m_udp_payload_axis_tvalid_int)) begin
            if (send_roce_header_reg == 3'd1) begin
                ptr_next = ptr_reg + 1;
                if ((OFFSET_BTH_ONLY != 0) &&
                    (CYCLE_BTH_ONLY_COUNT == 1 || ptr_next == CYCLE_BTH_ONLY_COUNT-1) &&
                    (send_roce_payload_reg == 3'd0)) begin
                    send_roce_payload_next          = 3'd1;
                    s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg &&
                                                      shift_roce_payload_96_axis_input_tready;
                end
                m_udp_payload_axis_tvalid_int = 1'b1;
                ...
                `_HEADER_BTH_FIELD_(1,  {solicited_event_reg, MIG_REQ, 2'd0, 4'd0})
                `_HEADER_BTH_FIELD_(2,  roce_bth_p_key_reg[1*8 +: 8])
                `_HEADER_BTH_FIELD_(3,  roce_bth_p_key_reg[0*8 +: 8])
                `_HEADER_BTH_FIELD_(4,  {FECN, 1'b0, 6'd0})
                ...
                `_HEADER_BTH_FIELD_(8,  {s_roce_bth_ack_req, 7'd0})
        ...
        if (m_udp_payload_axis_tready_int_reg &&
            (!OFFSET_BTH_RETH || (send_roce_payload_reg == 3'd0) || m_udp_payload_axis_tvalid_int)) begin
            if (send_roce_header_reg == 3'd2) begin
                ptr_next = ptr_reg + 1;
                if ((OFFSET_BTH_RETH != 0) &&
                    (CYCLE_BTH_RETH_COUNT == 1 || ptr_next == CYCLE_BTH_RETH_COUNT-1) &&
                    (send_roce_payload_reg == 3'd0)) begin
                    send_roce_payload_next          = 3'd2;
                    s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg &&
                                                      shift_roce_payload_224_axis_input_tready;
                end
                m_udp_payload_axis_tvalid_int = 1'b1;
                ...
                `_HEADER_BTH_RETH_FIELD_(1,  {solicited_event_reg, MIG_REQ, 2'd0, 4'd0})
                `_HEADER_BTH_RETH_FIELD_(2,  roce_bth_p_key_reg[1*8 +: 8])
                `_HEADER_BTH_RETH_FIELD_(3,  roce_bth_p_key_reg[0*8 +: 8])
                `_HEADER_BTH_RETH_FIELD_(4,  {FECN, 1'b0, 6'd0})
                ...
                `_HEADER_BTH_RETH_FIELD_(8,  {s_roce_bth_ack_req, 7'd0})
        ...
        if (m_udp_payload_axis_tready_int_reg &&
            (!OFFSET_BTH_RETH_IMMDH || (send_roce_payload_reg == 3'd0) || m_udp_payload_axis_tvalid_int)) begin
            if (send_roce_header_reg == 3'd3) begin
                ptr_next = ptr_reg + 1;
                if ((OFFSET_BTH_RETH_IMMDH != 0) &&
                    (CYCLE_BTH_RETH_IMMDH_COUNT == 1 || ptr_next == CYCLE_BTH_RETH_IMMDH_COUNT-1) &&
                    (send_roce_payload_reg == 3'd0)) begin
                    send_roce_payload_next          = 3'd3;
                    s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg &&
                                                      shift_roce_payload_256_axis_input_tready;
                end
                m_udp_payload_axis_tvalid_int = 1'b1;
                ...
                `_HEADER_BTH_RETH_IMMDH_FIELD_(1,  {solicited_event_reg, MIG_REQ, 2'd0, 4'd0})
                `_HEADER_BTH_RETH_IMMDH_FIELD_(2,  roce_bth_p_key_reg[1*8 +: 8])
                `_HEADER_BTH_RETH_IMMDH_FIELD_(3,  roce_bth_p_key_reg[0*8 +: 8])
                `_HEADER_BTH_RETH_IMMDH_FIELD_(4,  {FECN, 1'b0, 6'd0})
                ...
                `_HEADER_BTH_RETH_IMMDH_FIELD_(8,  {s_roce_bth_ack_req, 7'd0})
        ...
        if (m_udp_payload_axis_tready_int_reg &&
            (!OFFSET_BTH_IMMDH || (send_roce_payload_reg == 3'd0) || m_udp_payload_axis_tvalid_int)) begin
            if (send_roce_header_reg == 3'd4) begin
                ptr_next = ptr_reg + 1;
                if ((OFFSET_BTH_IMMDH != 0) &&
                    (CYCLE_BTH_IMMDH_COUNT == 1 || ptr_next == CYCLE_BTH_IMMDH_COUNT-1) &&
                    (send_roce_payload_reg == 3'd0)) begin
                    send_roce_payload_next          = 3'd4;
                    s_roce_payload_axis_tready_next = m_udp_payload_axis_tready_int_reg &&
                                                      shift_roce_payload_128_axis_input_tready;
                end
                m_udp_payload_axis_tvalid_int = 1'b1;
                ...
                `_HEADER_BTH_IMMDH_FIELD_(1,  {solicited_event_reg, MIG_REQ, 2'd0, 4'd0})
                `_HEADER_BTH_IMMDH_FIELD_(2,  roce_bth_p_key_reg[1*8 +: 8])
                `_HEADER_BTH_IMMDH_FIELD_(3,  roce_bth_p_key_reg[0*8 +: 8])
                `_HEADER_BTH_IMMDH_FIELD_(4,  {FECN, 1'b0, 6'd0})
                ...
                `_HEADER_BTH_IMMDH_FIELD_(8,  {s_roce_bth_ack_req, 7'd0})
        ...
        s_roce_bth_ready_next = !m_udp_hdr_valid_next &&
                                !((send_roce_header_next != 3'd0) || (send_roce_payload_next != 3'd0));
    end
    ...
    always @(posedge clk) begin
        ...
        if (store_roce_hdrs) begin
            ...
            if (s_roce_bth_op_code == RC_SEND_LAST      ||
                s_roce_bth_op_code == RC_SEND_LAST_IMD  ||
                s_roce_bth_op_code == RC_SEND_ONLY      ||
                s_roce_bth_op_code == RC_SEND_ONLY_IMD  ||
                s_roce_bth_op_code == RC_RDMA_WRITE_LAST_IMD ||
                s_roce_bth_op_code == RC_RDMA_WRITE_ONLY_IMD) begin
        ...
        if (flush_save) begin
            ...
            shift_roce_payload_96_extra_cycle_reg  <= OFFSET_BTH_ONLY ?
                s_roce_payload_axis_tlast && ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH-OFFSET_BTH_ONLY))) != 0) : 1'b0;
            shift_roce_payload_224_extra_cycle_reg <= OFFSET_BTH_RETH ?
                s_roce_payload_axis_tlast && ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH-OFFSET_BTH_RETH))) != 0) : 1'b0;
            shift_roce_payload_256_extra_cycle_reg <= OFFSET_BTH_RETH_IMMDH ?
                s_roce_payload_axis_tlast && ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH-OFFSET_BTH_RETH_IMMDH))) != 0) : 1'b0;
            shift_roce_payload_128_extra_cycle_reg <= OFFSET_BTH_IMMDH ?
                s_roce_payload_axis_tlast && ((s_roce_payload_axis_tkeep & ({KEEP_WIDTH{1'b1}} << (KEEP_WIDTH-OFFSET_BTH_IMMDH))) != 0) : 1'b0;
        end
    ...
    assign m_udp_payload_axis_tready_int_early =
        ...
        (!temp_m_udp_payload_axis_tvalid_reg && !m_udp_payload_axis_tvalid_reg);
